...
namespace RPG_Colaborate
{
    ...
    enum EffectType { NONEE, LOWERDEFENSE, TAUNT, BURN, COLD, FREEZE, POISON, WEAKEN, PERSEVERANCE, CONTSHOOT, SPACEGOAT, HIDE, FREEACTION, STRENGTH, GOLDBULLET, COUNTERATTACK };
